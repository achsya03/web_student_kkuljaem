...
@section('content')
    ...
    <div id="hero-dashboard" class="container">
      <div class="mt-4">
        <img class="gambar-detail-kelas mx-auto" src="{{ $class->url_mobile }}" width="1146px" height="516px" alt="" srcset="">
      </div>
    </div>
    <!-- close-hero-dashboard -->

    <div id="hero-detail" class="container mb-4">
      <h1>{{ $class->class_nama }}</h1>
      ...
      <div class="profil-mentor">
        <div class="row">
          ...
          <div class="col-lg-10">
              <a href="{{route('class.mentor', $class->mentor_uuid)}}" style="text-decoration: none; color: black">
        ...
        <div class="col-lg-12 button-video">
          <div class="button-pelajaran">
            ...
            @if ($index < 4)
              ...
              <div class="list-button-video">  
                ...
                <button class="btn-word">
                  <div class="row">
                    ...
                    <div class="col-lg-4">
                      <h6 class="mt-2 mr-4 text-right">{{ $item->jml_latihan }} Latihan {{ $item->jml_shadowing }} Shadowing</h6>
                    </div>
                  </div>
                </button>   
              </a>                                    
              ...
              @else
              <div class="list-button-video">  
                <a href="{{route('class.video', $item->content_quiz_uuid)}}">
                <button class="btn-word">
                  <div class="row">
                    <div class="col-lg-8 word-korea justify-content-center">
                      <p><img src=" @if ($item->type=='video')
            ...
            <div class="lainnya mt-3 mb-3" width="100%">
              <center><button type='button'onclick="window.location='{{ URL::route('class.video', $class->content[0]->content_video_uuid)}}'" class='btn btn-lainnya text-center py-2 my-1'> Materi Lainnya </button>
              </center>
            </div>        
          </div>
        </div>
