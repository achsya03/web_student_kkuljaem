    ...
    <div id="title-bar" class="my-3">
        <div class="container">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-jelajah-tab" data-toggle="pill" href="#pills-jelajah" role="tab"
                        aria-controls="pills-jelajah" aria-selected="true">
                        <h3>Jelajah</h3>
                    </a>
                </li>
            ...
            <div class="modal-body ">
              ...
              <div class="row my-4">
                ...
                <div class="col-lg-6 mx-auto my-2 ">
                  ...
                  <p class="text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eget sagittis ac eu molestie cursus.</p>
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-jelajah" role="tabpanel" aria-labelledby="pills-jelajah-tab">
            ...
            <div id="hero-kelas" class="container ">
                <div class="tittle-kelas">
                    <h3><a href="{{route('class.kategori',$item->category_uuid)}}"> {{$item->category}} </a></h3>
                    ...
                    <div class="pilihan-kelas">
                        <div class="card-deck">
                            ...
                            <button class="kelas">
                                <div class="row py-4">
                                    <div class="col-lg-6">
                                        <img  class="gambar-kelas mt-1" src="{{$children->url_web}}" width="273px" height="158px" srcset="">
                                    </div>
                                    <div class="col-lg-6 py-6 text-left">
                                        ...
                                        <div class="nama-guru">
                                            <a href="{{route('class.mentor', $children->mentor_uuid)}}" style="text-decoration: none; color: black">
                                            <h5>{{$children->mentor_nama ?? '-'}} <i class="fas fa-check-circle"></i></h5></a>
                                            
                                        </div>
                                        <div class="jumlah-materi mt-5">
                                            <h5>{{$children->jml_materi}} Materi</h5>
                                        </div>
                                    </div>
                                </div>
                            </button> 
                ...
                <div class="lainnya mt-3 mb-3" width="100%">
                    <center><button type='button' onclick="{{route('class.kategori',$item->category_uuid)}}" class='btn btn-lainnya text-center py-2 my-1'> Lainnya </button>
                    </center>
                </div>
                @else
                @endif
        ...
        <div class="tab-pane fade" id="pills-histori" role="tabpanel" aria-labelledby="pills-histori-tab">
                    ...
                    <div class="pilihan-kelas">
                        <div class="card-deck">                          
                            ...
                            <button class="kelas">
                                <div class="row py-4">
                                    <div class="col-lg-6">
                                        <img class="gambar-kelas mt-1" src="{{$item->class_url_web}}" width="273px" height="158px" srcset="">
                                    </div>
                                    <div class="col-lg-6 py-6 text-left">
                                        <div class="nama-kelas">
                                            <a href="{{route('class.detail', $children->class_uuid)}}" style="text-decoration: none; color: black">
                                        ...
                                        <div class="nama-guru">
                                            <h5>{{$item->mentor_nama ?? '-'}} <i class="fas fa-check-circle"></i></h6>
                                        </div>
                                        <div class="jumlah-materi mt-5">
                                            <h5>{{$item->class_jml_materi}} Materi</h6>
                                        </div>
                                    </div>
                                </div>
                            </button>
            ...
            <div id="hero-kelas" class="container ">
                    ...
                    <div class="pilihan-kelas">
                        <div class="card-deck">
                            ...
                            <button class="kelas">
                                <div class="row py-4">
                                    <div class="col-lg-6">                                       
                                        <img class="gambar-kelas" src="{{$item->class_url_web}}" width="273px" height="158px" srcset="">
                                    </div>
                                    <div class="col-lg-6 py-6 text-left">
                                        <div class="nama-kelas">
                                            <a href="{{route('class.detail', $children->class_uuid)}}" style="text-decoration: none; color: black">
                                        ...
                                        <div class="nama-guru">
                                            <h5>  {{$item->mentor_nama}} <i class="fas fa-check-circle"></i></h5>
                ...
                @if($index > 6)
                <div class="lainnya mt-3 mb-3" width="100%">
                    <center><button type='button' onclick="{{route('class.index')}}" class='btn btn-lainnya text-center py-2 my-1'> Lainnya </button>
                    </center>
                </div>
                @else
                @endif
