                                ...
                                <button class="kelas" onclick="window.location='{{ URL::route('class.detail', $item->class_uuid) }}'" >
                                    <div class="row py-4">
                                        ...
                                        <div class="col-lg-6 py-6 text-left deskripsi">
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar" style="width: @php echo ($item->class_prosentase*10) @endphp%" aria-valuenow="@php echo ($item->class_prosentase*10) @endphp" aria-valuemin="0" aria-valuemax="100"></div>
                                              </div>
                                            <div class="jumlah-materi">
