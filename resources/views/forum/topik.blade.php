            ...
            <div class="comment-forum p-4 ">
                <div class="d-flex justify-content-between mb-1 ">
                    <div class="profile-forum">
                        <img src="
                                @if ($value->stat_pengirim=='member data complete' && $value->jenis_kelamin=='L')
                ...
                <div class="pict-comentar ml-3">
                    <div class="card-deck">
                        ...
                        <img class="rounded mr-3" src="{{ $gambaritem->url_gambar }}" width="150px" height="120px"
                            alt="">
                        @endforeach
                    </div>
                </div>
                ...
                <div class="d-flex mt-3 like-comment ">
                    ...
                    <a href="{{ route('forum.unlike_post', $value->post_uuid) }}" style="text-decoration: none"
                        class="btn">
