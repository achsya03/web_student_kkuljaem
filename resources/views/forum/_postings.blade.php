...
<div id="post">
    ...
    @endif
    " alt="Avatar " class="float-left mr-3 rounded-circle  img-detail-comment">
            ...
            <h5>{{ $index->judul }}</h5>
            <h6 class="text-tag ">#{{ $index->tema }} testttttt</h6>
            <p>{!! nl2br($index->deskripsi) !!}</p>
...
<nav aria-label="Page navigation example pt-5">
    <ul class="pagination pagination-user justify-content-center">
        ...
        @if ($number == '...')
        <li class="page-item"><a class="page-link page-number" style="pointer-events: none;cursor: default;">{{ $number
                }}</a></li>
        @else
