                    ...
                    <div class="modal-dialog vertical-align-center" role="document">
                        <div class="modal-content" id="detail-pesanan">
                            <h2 class="font-weight-bold mb-5 title-detail"><img
                                ...
                                <input type="hidden" name="referal" value="{{$packets->nama_referal}}" id=""> --}}
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="d-flex flex-column">
                                        ...
                                        <h4 class="">{{ date('d M Y', strtotime($packets->tgl_daftar)) ?? ''}}</h4>
                                        <br>
                                ...
                                <div class="col-4">
                                    <div class="d-flex flex-column align-items-end">
                                        ...
                                        <h4 class="">- {{ date('d M Y', strtotime($packets->tgl_akhir)) ?? ''}}</h4>
                                        <br>
                                        <p class="mb-0">Pemilik</p>
                                        <h4 class="text-uppercase">{{$packets->nama_referal == 'Empty' ? '-' : $packets->nama_referal}} </h4>
                                    </div>
                                </div>
                            </div>
                            <a class="text-center my-4" href="{{$packets->payment->payment_url}}"><button class="btn btn-pesan mt-5">Pesan Sekarang</button></a>
                        </div>
                    </div>
                </div>
