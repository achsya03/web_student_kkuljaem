...
class ClassController extends Controller
{
    ...
    public function finish_video($id)
    {
        try {
            $clientService = new Client;
            $url = ApiEndpoint::$classVideoEnding . '?token=' . $id;
            ...
            if ($response->message == StatusApiConstant::$failed) {
                ...
                return redirect()->route('class.video',$id);
            }
        } catch (\Exception $th) {
            return redirect()->back()->withErrors($th->getMessage());
        }
    ...
    public function alert_post(Request $request) {
        ...
        try {
            ...
            if ($response->message == StatusApiConstant::$failed) {
                ...
                return redirect()->back()->with('success', $responseApi->getInfo());
            }
        } catch (\Exception $th) {
    ...
    public function create_comment(Request $request)
    {
        ...
        try {
            ...
            if ($response->message == StatusApiConstant::$failed) {
                ...
                return redirect()->route('class.video', $request->id);
            }
        } catch (\Exception $th) {
            return redirect()->back()->withErrors($th->getMessage());
        }
